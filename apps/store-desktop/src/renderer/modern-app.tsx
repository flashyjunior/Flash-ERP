  ...
  switch (kind) {
    ...
    case "order-collections":
      return report.salesOrderCollectionRows.map((row) => ({
        ...
        Status: row.status,
        Customer: row.customerName ?? "Customer",
        "Order Created By": row.orderCreatedBy ?? "",
        "Deposit Collected By": row.depositCollectedBy ?? "",
        "Sale Completed By": row.saleCompletedBy ?? "",
        "Balance Collected By": row.balanceCollectedBy ?? "",
