export const localStoreSchemaSql = `
...
CREATE TABLE IF NOT EXISTS pos_shift (
  ...
  status TEXT NOT NULL,
  opening_float_amount NUMERIC NOT NULL,
...
CREATE TABLE IF NOT EXISTS eod_reconciliation (
  ...
  declared_cash_amount NUMERIC NOT NULL,
  variance_amount NUMERIC NOT NULL,
  net_sales_amount NUMERIC NOT NULL,
  cash_tendered_amount NUMERIC NOT NULL,
  non_cash_tendered_amount NUMERIC NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_tax_profile_snapshot_updated_at ON tax_profile_snapshot(updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_tender_method_snapshot_sort ON tender_method_snapshot(status, sort_order, tender_method_name);
...
CREATE INDEX IF NOT EXISTS idx_inventory_location_snapshot_updated_at ON inventory_location_snapshot(updated_at DESC);
