...
import { updateEnterpriseProductProfile } from "@/server/repositories/enterprise-catalog.repository";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    ...
    const response = await updateEnterpriseProductProfile(productCode, {
      name: body.name ?? "",
      sku: body.sku ?? null,
