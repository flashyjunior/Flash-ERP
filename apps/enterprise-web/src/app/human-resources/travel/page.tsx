...
export default async function TravelPage() {
  ...
  const workspace = await getEmployeeFinanceWorkspace(permissions).catch((error: unknown) => buildUnavailableEmployeeFinanceWorkspace(error instanceof Error ? error.message : "Travel management is waiting for the database.", permissions));
  return <ErpEmployeeFinanceWorkspace view="travel" workspace={workspace} />;
}
