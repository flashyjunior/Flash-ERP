...
export default async function BenefitsPage() {
  ...
  const workspace = await getEmployeeFinanceWorkspace(permissions).catch((error: unknown) => buildUnavailableEmployeeFinanceWorkspace(error instanceof Error ? error.message : "Benefits are waiting for the database.", permissions));
  return <ErpEmployeeFinanceWorkspace view="benefits" workspace={workspace} />;
}
