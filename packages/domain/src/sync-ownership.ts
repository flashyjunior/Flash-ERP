...
export const entityOwnershipRules: Record<RetailEntityKey, EntityOwnershipRule> = {
  retailOrg: {
  ...
  customerAccountEntry: {
    ...
    notes:
      "Customer account postings are append-only financial facts that can originate from either enterprise or the store lane."
  },
  salesOrder: {
    authority: "store",
    upstreamFlow: true,
  ...
  unitOfMeasure: {
    ...
    downstreamFlow: true,
    conflictPolicy: "reject-store-overwrite",
    notes: "Units of measure are distributed from HQ so product quantities and fractional-sale rules stay aligned."
  },
  giftCertificate: {
    authority: "enterprise",
    upstreamFlow: false,
    downstreamFlow: true,
    conflictPolicy: "reject-store-overwrite",
    notes: "Gift certificate issuance and remaining balance posture are mastered centrally before stores consume them."
  },
  promotion: {
    authority: "enterprise",
    upstreamFlow: false,
  ...
  storeInstruction: {
    ...
    downstreamFlow: true,
    conflictPolicy: "manual-review",
    notes: "HQ sends controlled store administration instructions downstream through sync tasks."
  },
  inventoryTransfer: {
    authority: "store",
    upstreamFlow: true,
