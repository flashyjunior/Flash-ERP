import { normalizeLayawaySettings } from "./layaway-settings.js";
...
export function buildLayawayPolicySnapshot(settings, capturedAt) {
...
export function calculateLayawayMinimumDeposit(totalAmount, minimumDepositPercent) {
